...
return [
    ...
    'error-file-size'     => 'Размер файла выше допустимого! (максимальный размер: :max)',
    ...
    'error-folder-alnum'  => 'В названии папки допустимы только буквенно численные знаки!',
